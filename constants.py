...
MIN_THRESHOLD = 1.5  # minimum threshold in lidar scan derivative for a peak
PEAK_THRESHOLD = 0.5 # the relative value of points near peak to include
NUM_ADJACENT = 3     # the number of points adjacent to peak to consider
ADJ_THRESHOLD = 0.75 # the relative value of averaged values adjacent to peak
